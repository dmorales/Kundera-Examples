 ...
 */
/*
 * private List<Followers> getFollowers(String userId, String userName) { String
 * sql = "select a from Followers a where a.userId  =:userId"; Query q =
 * em.createQuery(sql); q.setParameter("userId", userId); List<Followers>
 * followers = q.getResultList(); return followers; }
 * 
 * 
 * (non-Javadoc)
 * 
 ...
 * 
 * @Override public void close() { if(em != null) { em.close(); }
 * 
 * }
 * 
 * }
